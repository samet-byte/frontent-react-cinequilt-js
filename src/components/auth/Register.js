...
const Register = () => {
    ...
    const disabled = !validName || !validPwd || !validMatch || !selectedCountry;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(REGISTER_URL,
                JSON.stringify({ username: user, email: email, password: pwd, country: selectedCountry.value, role: 'USER' }),
                {
