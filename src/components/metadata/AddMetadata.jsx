            ...
            <div className='row justify-content-center'>
                <div className='col-md-8 my-5'>
                    <h2 className='text-center mb-4'>Add Content</h2>
                    {
                        isSubmitted ?
                            <Loading/> :
                            MetadataForm(saveMetadata, type, handleInputChange, title, director, releaseYear, season, episode, duration, description, genre, posterUrl, videoUrl, trailerUrl, soundtrackUrl)}
                </div>
            </div>
        </div>
  )
